...
export default function LandingPage({ onNavigate }) {
  const waveRef     = useWaveCanvas(true, { amplitude: 10, speed: 0.06 });
    ...
    <div className="page-enter">
      ...
      <section className="hero">
        ...
        <div className="hero-left">
          ...
          <div className="hero-actions">
            <button className="btn-primary btn-primary--lg" onClick={() => onNavigate('upload')}>
              Analyze a Video
            </button>
      ...
      <section className="steps-section" id="how-it-works">
        ...
        <div className="steps-grid">
          ...
          <StepCard
            ...
            label="STEP 02"
            title="Analyze"
            body="Our phase-based Riesz-pyramid algorithm amplifies subtle motions up to 1000×. Select frequency bands and regions of interest."
            icon={
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
          ...
          <StepCard
            ...
            label="STEP 03"
            title="Discover"
            body="Identify dominant frequencies, structural anomalies, and vibration patterns with engineering confidence."
            icon={
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      ...
      <section className="cta-section">
        <div className="cta-inner">
          ...
          <button
            className="btn-saffron btn-saffron--lg"
